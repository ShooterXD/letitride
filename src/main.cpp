...
#if defined(NDEBUG)
# error "LetItRide cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "LetItRide Signed Message:\n";
...
{
    RenameThread("LetItRide-loadblk");
